...
public class GetBitmapTask extends AsyncTask<String, Void, Bitmap> {
	...
	protected void onPostExecute(Bitmap bitmap) {
		...
		if(imageViewRef != null) {
			...
			MediaStore.Images.Media.insertImage(parent.getContentResolver(), bitmap, "Sharkbytes Wallpaper", "saved from sharkbytes.co");
			Toast.makeText(parent, "Image Saved to Gallery", Toast.LENGTH_SHORT).show();
		}
	}
}